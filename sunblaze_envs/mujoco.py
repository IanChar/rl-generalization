...
class RandomHeavyTorsoHalfCheetah(
    RoboschoolXMLModifierMixin, ModifiableRoboschoolHalfCheetah
):
...
class SlipperyJointsHalfCheetah(
    RoboschoolXMLModifierMixin, ModifiableRoboschoolHalfCheetah
):
    def __init__(self):
        self.friction = 0.2
...
class RandomRoughJointsHalfCheetah(
    RoboschoolXMLModifierMixin, ModifiableRoboschoolHalfCheetah
):
...
class RandomSlipperyJointsHalfCheetah(
    RoboschoolXMLModifierMixin, ModifiableRoboschoolHalfCheetah
):
    def randomize_friction(self):
...
class RandomSlipperyJointsHopper(
    RoboschoolXMLModifierMixin, ModifiableRoboschoolHopper
):
    def randomize_friction(self):
        self.friction = uniform_exclude_inner(
            self.np_random.uniform,
